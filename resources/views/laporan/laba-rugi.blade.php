...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3 col-6">
        <div class="stat-card" style="background:linear-gradient(135deg,#6366f1,#4f46e5)">
            <div class="icon">📦</div>
            <div class="label">Modal Pembelian Stok</div>
            <div class="value">Rp {{ number_format($modal,0,',','.') }}</div>
        </div>
    </div>
    <div class="col-md-3 col-6">
    ...
    <div class="col-md-5">
            ...
            <div class="card-body p-0">
                <table class="table mb-0" style="font-size:13px">
                    <tbody>
                        ...
                        <tr><td class="ps-3 text-muted">( - ) Modal Pembelian Stok</td><td class="text-end pe-3 text-danger">Rp {{ number_format($modal,0,',','.') }}</td></tr>
                        ...
                        <tr><td class="ps-3 text-muted">( - ) Total Pengeluaran</td><td class="text-end pe-3 text-danger">Rp {{ number_format($totalPengeluaran,0,',','.') }}</td></tr>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div class="d-flex justify-content-between px-3 py-2 border-bottom" style="font-size:13px">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <table class="table mb-0" style="font-size:12px">
                    <thead><tr><th class="ps-3">No. Invoice</th><th>Pelanggan</th><th>Grandtotal</th><th>Status</th></tr></thead>
                    <tbody>
